        ...
        <div className="bg-[#f8fafc] relative h-screen">
            ...
            <div className="w-full">
                ...
                <div className="bg-white shadow-sm mt-5 rounded-2xl overflow-hidden w-full  border-gray-600">
                    <div className="flex flex-row rounded-t-2xl px-6 py-3  text-gray-600 bg-gray-100">
                        ...
                        {filteredJobs.map(job => (
                            <div key={job.id} className="flex flex-row items-center px-6 py-4 border-b border-gray-300">
                                ...
                                <div className="w-1/6 relative ">
                                    ...
                                    {openMenuId === job.id &&
                                        <div className="flex flex-col absolute top-3 right-30 bg-white shadow-md rounded-lg py-1 z-10 w-24">
                    ...
                    <div className="flex flex-row justify-end mr-10 mt-5">
                        ...
                        {showModal &&
                            ...
                            <div className="flex flex-row justify-center absolute inset-0 bg-[#f8fafc] bg-opacity-50">
                                ...
                                <div className="h-3/4 flex flex-col items-center rounded-2xl bg-white mt-12 w-full max-w-3xl p-12 shadow-sm border border-slate-100 font-sans antialiased">
                            ...
                            // Modal end for new entry screen input
                        } </div>
                </div>
            </div>
        </div >
